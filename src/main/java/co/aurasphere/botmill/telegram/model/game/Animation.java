...
/**
 * You can provide an animation for your {@link Game} so that it looks stylish
 * in chats (check out Lumberjack for an example). This object represents an
...
public class Animation implements Serializable {
	...
	public String toString() {
		return "Animation [fileId=" + fileId + ", thumb=" + thumb
